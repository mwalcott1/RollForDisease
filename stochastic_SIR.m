...
% load & process data
path = "C:\Users\miles\Downloads\MATH431\FinalProj\cleanedData\covid_Singapore.csv";
...
best_params = lsqnonlin(@(p) ssir_lsq(dates,x0,p,processed_data), params,lb,ub,options);
best_params
